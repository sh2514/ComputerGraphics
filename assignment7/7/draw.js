...
function drawPictureOnCanvas() {
    var canvas = initCanvas('editorCanvas');
        ...
        */
        ...
        // Back right leg
        for (var i = 0; i < 20; i++) {
            sx = .25 + (Math.random() - .25) / 30;
            sy = .05 + (Math.random() - .25) / 30;
            ex = .15 + (Math.random() - .25) / 30;
            ey = -.20 + (Math.random() - .25) / 30;
            sxr = (Math.random() / 1.5);
            syr = (Math.random() / 1.5);
            exr = (Math.random() / 1.5);
            eyr = (Math.random() / 1.5);
        ...
        // Body
        for (var i = 0; i < 150; i++) {
            sx = -.25 + (Math.random() - .25) / 2;
            sy = 0 + (Math.random() - .25) / 2;
            ex = .35 + (Math.random() - .25) / 2;
            ey = 0 + (Math.random() - .25) / 2;
            sxr = (Math.random());
            syr = (Math.random());
            exr = (Math.random());
            eyr = (Math.random());
        ...
        // Front left leg
        for (var i = 0; i < 20; i++) {
            sx = 0 + (Math.random() - .25) / 30;
            sy = 0 + (Math.random() - .25) / 30;
            ex = -.1 + (Math.random() - .25) / 30;
            ey = -.30 + (Math.random() - .25) / 30;
            sxr = (Math.random() / 2);
            syr = (Math.random() / 2);
            exr = (Math.random() / 2);
            eyr = (Math.random() / 2);
        ...
        // Front right leg
        for (var i = 0; i < 20; i++) {
            sx = -.35 + (Math.random() - .25) / 30;
            sy = .05 + (Math.random() - .25) / 30;
            ex = -.45 + (Math.random() - .25) / 30;
            ey = -.25 + (Math.random() - .25) / 30;
            sxr = (Math.random() / 2);
            syr = (Math.random() / 2);
            exr = (Math.random() / 2);
            eyr = (Math.random() / 2);
        ...
        // Back left leg
        for (var i = 0; i < 30; i++) {
            sx = .4 + (Math.random() - .25) / 30;
            sy = 0 + (Math.random() - .25) / 30;
            ex = .3 + (Math.random() - .25) / 30;
            ey = -.30 + (Math.random() - .25) / 30;
            sxr = (Math.random() / 1.5);
            syr = (Math.random() / 1.5);
            exr = (Math.random() / 1.5);
        ...
        // Hair
        for (var i = 0; i < 150; i++) {
            sx = -.5 + (Math.random() - .25) / 1.5;
            sy = -.05 + (Math.random() - .25) / 1.5;
            ex = -.5 + (Math.random() - .25) / 1.5;
            ey = -.05 + (Math.random() - .25) / 1.5;
            sxr = (Math.random());
            syr = (Math.random());
            exr = (Math.random());
            eyr = (Math.random());
        ...
        // Face
        for (var i = 0; i < 100; i++) {
            sx = -.5 + (Math.random() - .25) / 2.5;
            sy = 0 + (Math.random() - .25) / 2.5;
            ex = -.5 + (Math.random() - .25) / 2.5;
            ey = 0 + (Math.random() - .25) / 2.5;
            sxr = (Math.random() / 1.1);
            syr = (Math.random() / 1.1);
            exr = (Math.random() / 1.1);
            eyr = (Math.random() / 1.1);
        ...
        // Right eye
        for (var i = 0; i < 20; i++) {
            sx = -.5 + (Math.random() - .25) / 30;
            sy = .15 + (Math.random() - .25) / 30;
            ex = -.5 + (Math.random() - .25) / 30;
            ey = .15 + (Math.random() - .25) / 30;
            sxr = (Math.random() / 4);
            syr = (Math.random() / 4);
            exr = (Math.random() / 4);
            eyr = (Math.random() / 4);
        ...
        // Nose
        for (var i = 0; i < 20; i++) {
            sx = -.45 + (Math.random() - .25) / 30;
            sy = 0 + (Math.random() - .25) / 30;
            ex = -.45 + (Math.random() - .25) / 30;
            ey = 0 + (Math.random() - .25) / 30;
            sxr = (Math.random() / 2.5);
            syr = (Math.random() / 2.5);
            exr = (Math.random() / 2.5);
            eyr = (Math.random() / 2.5);
        ...
        for (var i = 0; i < 20; i++) {
            sx = -.45 + (Math.random() - .25) / 30;
            sy = -.1 + (Math.random() - .25) / 30;
            ex = -.48 + (Math.random() - .25) / 30;
            ey = -.12 + (Math.random() - .25) / 30;
            sxr = (Math.random() / 2.5);
            syr = (Math.random() / 2.5);
            exr = (Math.random() / 2.5);
            eyr = (Math.random() / 2.5);
...
function editSpline(arg) {
    document.getElementById("hideEditPane").hidden = false;
    var splineNum = 0;
    for (var i = 0; i < splines.length; i++) {
        if (splines[i] !== null && splines[i].splineID === arg) {
            splineNum = i;
            break;
        }
    }
    document.getElementById('esplineID').innerHTML = 'Spline ' + arg;
    document.getElementById('estartX').value = splines[splineNum].startX;
    document.getElementById('estartY').value = splines[splineNum].startY;
    document.getElementById('eendX').value = splines[splineNum].endX;
    document.getElementById('eendY').value = splines[splineNum].endY;
    document.getElementById('estartXR').value = splines[splineNum].startXR;
    document.getElementById('estartYR').value = splines[splineNum].startYR;
    document.getElementById('eendXR').value = splines[splineNum].endXR;
    document.getElementById('eendYR').value = splines[splineNum].endYR;
    document.getElementById('esplineColor').value = splines[splineNum].splineColor;
}

function deleteSpline(argSplineID) {
    for (var i = 0; i < splines.length; i++) {
        if (splines[i] !== null && splines[i].splineID === argSplineID) {
            splines[i] = null;
        }
    }

    var deleteSplineDiv = document.getElementById(argSplineID);
    deleteSplineDiv.parentNode.removeChild(deleteSplineDiv);
    document.getElementById('editSuccessIndicator').style.color = 'lightgreen';
    document.getElementById('editSuccessIndicator').innerHTML = "Spline " + argSplineID + " deleted successfully!";

    //drawOnEditorCanvas();
}

function editSplineSubmitButton() {
    var splineStr= document.getElementById('esplineID').innerHTML;
    var splineID = splineStr.split(" ")[1];
    var startX = document.getElementById('estartX').value;
    var startY = document.getElementById('estartY').value;
    var endX = document.getElementById('eendX').value;
    var endY = document.getElementById('eendY').value;
    var startXR = document.getElementById('estartXR').value;
    var startYR = document.getElementById('estartYR').value;
    var endXR = document.getElementById('eendXR').value;
    var endYR = document.getElementById('eendYR').value;
    var splineColor = document.getElementById('esplineColor').value;

    var splineNum = 0;
    for (var i = 0; i < splines.length; i++) {
        if (splines[i] !== null && splines[i].splineID === splineID) {
            splineNum = i;
            break;
        }
    }
    if (startX !== "" && startY !== "" && endX !== "" && endY !== "" &&
        startXR !== "" && startYR !== "" && endXR !== "" && endYR !== "") {
        splines[splineNum].startX = startX;
        splines[splineNum].startY = startY;
        splines[splineNum].endX = endX;
        splines[splineNum].endY = endY;
        splines[splineNum].startXR = startXR;
        splines[splineNum].startYR = startYR;
        splines[splineNum].endXR = endXR;
        splines[splineNum].endYR = endYR;
        splines[splineNum].splineColor = splineColor;

        var editSplineDiv = document.getElementById(splineID);
        while (editSplineDiv.firstChild) {
            editSplineDiv.removeChild(editSplineDiv.firstChild);
        }
        var newText = document.createTextNode("Spline: " + splineID + ", ");
        editSplineDiv.appendChild(newText);
        newText = document.createTextNode("startX: " + startX + ", ");
        editSplineDiv.appendChild(newText);
        newText = document.createTextNode("startY: " + startY + ", ");
        editSplineDiv.appendChild(newText);
        newText = document.createTextNode("endX: " + endX + ", ");
        editSplineDiv.appendChild(newText);
        newText = document.createTextNode("endY: " + endY + ", ");
        editSplineDiv.appendChild(newText);
        newText = document.createTextNode("startXr: " + startXR + ", ");
        editSplineDiv.appendChild(newText);
        newText = document.createTextNode("startYr: " + startYR + ", ");
        editSplineDiv.appendChild(newText);
        newText = document.createTextNode("endXr: " + endXR + ", ");
        editSplineDiv.appendChild(newText);
        newText = document.createTextNode("endYr: " + endYR + ", ");
        editSplineDiv.appendChild(newText);
        newText = document.createTextNode("color: " + splineColor + " ");
        editSplineDiv.appendChild(newText);

        var newEditButton = document.createElement('button');
        newEditButton.innerHTML = 'Edit';
        newEditButton.value = splineID;
        newEditButton.onclick = function () { editSpline(this.value) };
        editSplineDiv.appendChild(newEditButton);

        var newDeleteButton = document.createElement('button');
        newDeleteButton.innerHTML = 'Delete';
        newDeleteButton.value = splineID;
        newDeleteButton.onclick = function () { deleteSpline(this.value) };
        editSplineDiv.appendChild(newDeleteButton);

        document.getElementById('editSuccessIndicator').style.color = 'lightgreen';
        document.getElementById('editSuccessIndicator').innerHTML = "Spline " + splines[splineNum].splineID + " successfully updated!";
        document.getElementById("hideEditPane").hidden = true;
    }
    else {
        document.getElementById('editSuccessIndicator').style.color = 'red';
        document.getElementById('editSuccessIndicator').innerHTML = "Edit spline failed!  Check edit parameters!";
    }
    ...
    canvas.update = function (g) {
        ...
        for (var i = 0; i < splines.length; i++) {
            if (splines[i] !== null) {
                ...
                if (this.cursor.z) {
                    //xModifiers.y = splines[i].endX + Math.sin(Math.random());
                    //yModifiers.y = splines[i].endY + Math.sin(time);
                    xModifiers.z = splines[i].startXR * (this.cursor.x / canvas.width) * 5;
                    xModifiers.w = splines[i].endXR * (this.cursor.x / canvas.width) * 5;
                    yModifiers.z = splines[i].endYR * (this.cursor.y / canvas.width) * 5;
                    yModifiers.w = splines[i].endYR * (this.cursor.y / canvas.width) * 5;
                }


                for (var t = 0.00; t <= 1.01; t += 0.01) {
                    var original = new Vector4();
                    original.x = hermite(xModifiers, t);
                    original.y = hermite(yModifiers, t);
                    original.z = 0;
